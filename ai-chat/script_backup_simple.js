...
async function loadChatHistory() {
    ...
    try {
        const response = await fetch('http://103.163.118.181:5001/api/chatbot/get/title/history/', {
            headers: { 'Authorization': `Bearer ${token}` }
        });
...
let chatToken = null;
const API_BASE_URL = 'http://103.163.118.181:5001/api/chatbot/post/question';
...
async function loadChatMessages(token) {
    ...
    try {
        const response = await fetch(`http://103.163.118.181:5001/api/chatbot/get/history/${token}`, {
