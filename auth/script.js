...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (registerForm) {
        registerForm.addEventListener('submit', async (e) => {
            ...
            try {
                ...
                const response = await fetch('http://103.163.118.181:5001/api/auth/register', {
                    method: 'POST',
                    headers: {
    ...
    if (loginForm) {
        loginForm.addEventListener('submit', async (e) => {
            ...
            try {
                const response = await fetch('http://103.163.118.181:5001/api/auth/login', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                    },
    ...
    if (otpForm) {
        otpForm.addEventListener('submit', async (e) => {
            ...
            try {
                const response = await fetch('http://103.163.118.181:5001/api/auth/verify-otp', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                    },
    ...
    if (forgotPasswordForm) {
        forgotPasswordForm.addEventListener('submit', async (e) => {
            ...
            try {
                const response = await fetch('http://103.163.118.181:5001/api/auth/forget-password', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                    },
    ...
    if (resetPasswordForm) {
        ...
        resetPasswordForm.addEventListener('submit', async (e) => {
            ...
            try {
                const response = await fetch('http://103.163.118.181:5001/api/auth/reset-password', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                    },
